...
class ResultExamsPage extends StatefulWidget {
  const ResultExamsPage({Key? key}) : super(key: key);

  @override
  State<ResultExamsPage> createState() => _ResultExamsPageState();
}

class _ResultExamsPageState extends State<ResultExamsPage>
  ...
  void createTabExternalExam(ExternalExamFileEntity? externalExamFile) {
    if (externalExamFile?.path != null && externalExamFile?.file != null) {
      tabs.add(ZeraTab(tabText: 'Resultado'));
