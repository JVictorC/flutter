...
class RadiationExposureHistoryPage extends StatefulWidget {
  const RadiationExposureHistoryPage({Key? key}) : super(key: key);

  @override
  State<RadiationExposureHistoryPage> createState() =>
      _RadiationExposureHistoryPageState();
}

class _RadiationExposureHistoryPageState
    extends State<RadiationExposureHistoryPage> {
  late bool loaded;
