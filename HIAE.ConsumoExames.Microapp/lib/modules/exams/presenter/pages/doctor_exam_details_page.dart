...
class DoctorExamDetailsPage extends StatefulWidget {
  const DoctorExamDetailsPage({Key? key}) : super(key: key);

  @override
  State<DoctorExamDetailsPage> createState() => _DoctorExamDetailsPageState();
}

class _DoctorExamDetailsPageState extends State<DoctorExamDetailsPage> {
  late bool loaded;
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  Navigator.of(context).pushNamed(
                                    Routes.doctorRadiationExposureHistoryPage,
